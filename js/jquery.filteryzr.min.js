...
! function (t, i) {
  ...
  r.prototype = {
      ...
      fit: function (t) {
        ...
        for (this.root.h = o,
          i = 0; n > i; i++)
          e = t[i],
          (r = this.findNode(this.root, e.w, e.h)) ? e.fit = this.splitNode(r, e.w, e.h) : e.fit = this.growDown(e.w, e.h)
      },
    ...
    i.fn.filterizr = function () {
      var t = this,
        r = arguments;
      if (t._fltr || (t._fltr = i.fn.filterizr.prototype.init(t.selector, "object" == typeof r[0] ? r[0] : void 0)),
        "string" == typeof r[0]) {
    ...
    i.fn.filterizr.prototype = {
      init: function (t, r) {
        ...
        return e.options = {
          ...
          0 === arguments.length && (t = e.options.selector,
            r = e.options),
          ...
          e._uID = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (t) {
      ...
      toggleFilter: function (t) {
        ...
        i.trigger("filteringStart"),
          ...
          i._multifilterModeOn() ? (r = i._makeMultifilterArray(),
            i._handleFiltering(r),
            i._isSearchActivated() && i.search(i._typedText)) : (i.filter("all"),
            i._isSearchActivated() && i.search(i._typedText))
      },
      search: function (t) {
        var i = this,
      ...
      _makeSubarrays: function () {
        ...
        for (r = 0; r < t._mainArray.length; r++)
          if ("object" == typeof t._mainArray[r]._category)
            ...
            i[t._mainArray[r]._category - 1].push(t._mainArray[r]);
        return i
      },
      _makeMultifilterArray: function () {
        for (var t = this, i = [], r = {}, e = 0; e < t._mainArray.length; e++) {
          ...
          if (Array.isArray(n._category)) {
            ...
            n._category in t._toggledCategories && (o = !0);
          a && o && (r[n.domIndex] = !0,
            i.push(n))
        }
        return i
      ...
      _setupControls: function () {
        ...
        i("*[data-filter]").click(function () {
          ...
          i("*[data-multifilter]").click(function () {
            ...
            "all" === r ? (t._toggledCategories = {},
              t.filter("all")) : t.toggleFilter(r)
          }),
      ...
      _calcItemPositions: function () {
        ...
        if ("horizontal" === t.options.layout)
          ...
          for (c = 1; c <= e.length; c++)
            ...
            f += s,
            c % o === 0 && (u += e[0].outerHeight(),
              f = 0);
          a = Math.ceil(e.length / o),
            n = a * e[0].outerHeight()
        }
        return t.css("height", n),
          _
      },
      _handleFiltering: function (t) {
        for (var i = this, r = i._getArrayOfUniqueItems(i._activeArray, t), e = 0; e < r.length; e++)
          r[e]._filterOut();
        i._activeArray = t,
          i._placeItems(t)
      },
  ...
  var e = {
    ...
    _calcDelay: function () {
      var t = this,
        i = 0;
      return "progressive" === t._parent.options.delayMode ? i = t._parent.options.delay * t.domIndex : t.domIndex % 2 === 0 && (i = t._parent.options.delay),
        i
    },
    ...
    _onTransitionEnd: function () {
      var t = this;
      t._filteringOut ? (i(t).addClass("filteredOut"),
          t._isFilteredOut = !0,
          t._filteringOut = !1) : t._filteringIn && (t._isFilteredOut = !1,
          t._filteringIn = !1),
        t._parent._isAnimating && (t._parent._isShuffling ? t._parent.trigger("shufflingEnd") : t._parent._isSorting ? t._parent.trigger("sortingEnd") : t._parent.trigger("filteringEnd"),
