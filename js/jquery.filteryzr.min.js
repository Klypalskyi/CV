    ...
    r.prototype = {
        ...
        fit: function (t) {
            ...
            for (this.root.h = o, i = 0; n > i; i++)
                e = t[i], (r = this.findNode(this.root, e.w, e.h)) ? e.fit = this.splitNode(r, e.w, e.h) : e.fit = this.growDown(e.w, e.h)
        },
        ...
        _calcItemPositions: function () {
            ...
            if ("horizontal" === t.options.layout)
                for (a = 1, c = 1; c <= e.length; c++)
                    s = e[c - 1].outerWidth(), l = e[c - 1].outerHeight(), _.push({
                        left: f,
                        top: u
                    }), f += s, l > n && (n = l);
            else if ("vertical" === t.options.layout) {
                for (c = 1; c <= e.length; c++)
                    l = e[c - 1].outerHeight(), _.push({
                        left: f,
                        top: u
                    }), u += l;
                n = u
                ...
                for (c = 1; c <= e.length; c++) {
                    if (_.push({
                        ...
                        for (g = a; g > 0;)
                            u += e[c - o * g].outerHeight(), g--;
                    c % o === 0 && (f = 0)
                }
                for (c = 0; o > c; c++) {
                    for (var m = 0, v = c; e[v];)
                        m += e[v].outerHeight(), v += o;
                    m > n ? (n = m, m = 0) : m = 0
                }
        ...
        _fisherYatesShuffle: function (t) {
            for (var i, r, e = t.length; e;)
                r = Math.floor(Math.random() * e--), i = t[e], t[e] = t[r], t[r] = i;
            return t
        }
    };
    var e = {
